 ...
 * @extends {ItemSheetV2}
 */
export class ForgeItemSheet extends api.HandlebarsApplicationMixin(
  sheets.ItemSheetV2
) {
  constructor(options = {}) {
    super(options);
  ...
  static PARTS = {
    header: {
      template: 'systems/forge/templates/item/header.hbs',
    },
    tabs: {
    ...
    description: {
      template: 'systems/forge/templates/item/description.hbs',
    },
    attributesFeature: {
      template:
        'systems/forge/templates/item/attribute-parts/feature.hbs',
    },
    attributesGear: {
      template: 'systems/forge/templates/item/attribute-parts/gear.hbs',
    },
    attributesSpell: {
      template: 'systems/forge/templates/item/attribute-parts/spell.hbs',
    },
    effects: {
      template: 'systems/forge/templates/item/effects.hbs',
    },
  };
